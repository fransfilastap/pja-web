...
```php title="app/config/saml2_settings.php"
'idpNames' => ['wso2is'],
```
...
```php title="app\Http\Controllers\Wso2Saml2Controller.php"
<?php
...
```php title="app/actions/SyncUserFromWSO2.php"
<?php
...
```php title="app/Actions/WSO2ISClaims.php"
<?php
...
```php title="saml2_config.php" showLineNumbers {2}
<?php
...
```php title="app\Http\Kernel.php" {5,6,7,8,9}
<?php
