...
date: 2022-01-09
cover: https://images.unsplash.com/photo-1618044619888-009e412ff12a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1771&q=80
author: Frans Filasta Pratama
description: How to apply SSO (SAML2) using WSO2 Identity Server on laravel application.
tags:
  - laravel
  - sso
  - wso2
